...
const HeroSection = () => {
  ...
  return <section className="relative w-full h-screen overflow-hidden">
      <audio ref={audioRef} loop preload="auto">
        <source src="https://cdn.pixabay.com/audio/2024/09/04/audio_e4dc54fe22.mp3" type="audio/mpeg" />
      </audio>
      
      <video ref={videoRef} autoPlay muted playsInline className="absolute inset-0 w-full h-full object-cover transition-transform duration-300 ease-out" style={{
      transform: `translate(${parallax.x}%, ${parallax.y}%) scale(1.15)`
    }}>
        <source src="https://res.cloudinary.com/duxxuvpkt/video/upload/v1760612324/final_video_kid_no_watermarks_ttagks.mp4" type="video/mp4" />
      </video>
      ...
      <div className="absolute left-0 top-1/2 -translate-y-1/2 pl-8 sm:pl-12 md:pl-16 lg:pl-20 max-w-xl lg:max-w-2xl z-10">
        ...
        <div className="max-w-lg mt-6">
          <Button size="lg" onClick={() => navigate("/stories")} className="w-full bg-hero-orange hover:bg-hero-orange/90 text-white px-12 py-6 rounded-full font-fredoka text-xl font-semibold hover:scale-105 transition-all duration-300 shadow-[0_8px_24px_rgba(255,140,66,0.5)] hover:shadow-[0_12px_32px_rgba(255,140,66,0.7)]">
      ...
      transform: `translate(${parallax.x * 0.5}%, ${parallax.y * 0.5}%)`
    }}>
        <FloatingStars />
      </div>
    </section>;
